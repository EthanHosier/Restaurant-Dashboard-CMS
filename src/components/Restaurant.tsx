...
const pickupDeliveryOptionsMacro = (checkboxType: CheckboxType) =>
  checkboxType === CheckboxType.Delivery ? "deliveryOptions" : "pickupOptions";

const Restaurant = ({
  /*bookings,*/ locations: existingLocations,
}: {
  ...
  const handleRemoveLocation = async (locationId: string) => {
    ...
    setFormData((data) =>
      data.filter((location) => location.locationId != locationId)
    );
  ...
  const handleMaxStayDurationChange = (
    location: Location,
  ...
  const handleOpenCloseTimeChange = (
    location: Location,
    day: number,
    type: string,
    time: string
  ...
  const changePickupDeliveryType = (
    location: Location,
    checkboxType: CheckboxType,
    index: number,
    type: string
  ...
  const addReviewOption = (location: Location) => {
    ...
    location.reviewOptions
      ? location.reviewOptions.push(element)
      : (location.reviewOptions = [element]);
    setFormData((f) => [...f]);
    enableSaving();
  };
      ...
      {loading ? (
        ...
        <>
          <Card className="w-full p-4 mt-4 bg-[#F1F5F9]">
            <Card className="p-4 mb-4 w-full">
              ...
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    Please ensure that you are including the "https://" part at
                    the start of each url. For example "https://www.google.com"
            ...
            <Button className="" onClick={addVenue}>
              <Plus size={16} color="white" className="mr-2" />{" "}
              <p className="ml-2">Add Venue</p>
            </Button>
                  ...
                  {formData.map((location, i) => (
                    <Card className="p-4 mb-16 w-full xl:flex-1" key={i}>
                      ...
                      <div className="w-full flex justify-between mt-4">
                        <CardTitle className="text-xl">Venue {i + 1}</CardTitle>
                      ...
                      <Card className="p-4 mt-4">
                        ...
                        {Object.keys(location.openingTimes)
                          .sort((a, b) => {
                                  ...
                                  <select
                                    ...
                                    value={
                                      location.openingTimes[
                                        DAYS_OF_WEEK[
                                          i
                                        ] as keyof typeof location.openingTimes
                                      ]?.open
                                    }
                                    onChange={(e) =>
                                      handleOpenCloseTimeChange(
                                        location,
                                        i,
                                        "open",
                                        e.target.value
                      ...
                      <Card className="mt-4 p-4">
                        ...
                        <div className="w-full flex flex-col">
                          {location.tables.length > 0 && (
                            <p className="ml-[38px] mt-4 font-medium mb-2">
                              Capacity
                            </p>
                          )}
                          <div className="w-full">
                            {location.tables.map((table, j) => (
                              ...
                              >
                                ...
                                <Button
                                  type="button"
                                  onClick={() =>
                                    handleRemoveTable(location, table.id)
                                  }
                                  variant="ghost"
                                  className=""
                                >
                      ...
                      <Card className="p-4 mt-4">
                        ...
                        {location.pickup && (
                          <Card className="p-4 overflow-auto">
                            ...
                            <div className="w-full flex flex-col">
                              {location.pickup &&
                                location.pickupOptions.length > 0 && (
                                  <div className="flex mt-4 w-8 mb-2">
                                    <p className="font-medium ">Type</p>
                                    <p className="ml-[106px] font-medium">
                                      URL
                                    </p>
                                  </div>
                                )}
                              ...
                              <div className="w-full">
                                {location.pickupOptions.map(
                                  (pickupOption, j) => (
                                    ...
                                    >
                                      <select
                                        id={`pickupOption${toTitleCase(
                                          location.name
                                        )}${j}`}
                                        name={`pickupOption${toTitleCase(
                                          location.name
                                        )}${j}`}
                                        value={pickupOption.type}
                                        onChange={(e) =>
                                          changePickupDeliveryType(
                                            location,
                                            CheckboxType.Pickup,
                                            j,
                                            e.target.value
                            ...
                            <Button
                              ...
                              type="button"
                              onClick={() =>
                                addPickupDelivery(location, CheckboxType.Pickup)
                              }
                            >
                              <Plus size={16} color="white" className="mr-2" />
                              Add Pickup Option
                              ...
                              <div className="w-full">
                                {location.deliveryOptions.map(
                                  (deliveryOption, j) => (
                                    ...
                                    >
                                      <select
                                        id={`deliveryOption${toTitleCase(
                                          location.name
                                        )}${j}`}
                                        name={`deliveryOption${toTitleCase(
                                          location.name
                                        )}${j}`}
                      ...
                      <Card className="p-4 mt-4 overflow-auto">
                        <CardTitle className="mb-4">Review Options</CardTitle>
                        ...
                        <div className="w-full flex flex-col">
                          ...
                          <div className="w-full">
                            {location.reviewOptions?.map((reviewOption, j) => (
                              ...
                              >
                                <select
                                  id={`reviewOption${toTitleCase(
                                    location.name
                                  )}${j}`}
                                  name={`reviewOption${toTitleCase(
                                    location.name
                                  )}${j}`}
                                  value={reviewOption.type}
                                  onChange={(e) =>
                                    changeReviewOptionType(
                                      location,
                                      j,
                                      e.target.value
                                    )
